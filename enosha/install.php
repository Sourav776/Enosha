...
<div id="wrap">
  ...
  <div id="con">
    <div id="inner">
      ...
      <form id="form1" name="form1" method="post" action="lib/setup/install.php">
        <table width="700" border="0">
          <tr>
            <td width="169">Platform</td>
            <td width="521"><label>
          ...
          <tr>
           ...
           <tr>
            ...
            <td><label>
              ...
              <i>(e.g: /var/enoshadata)</i></label></td>
          </tr>
           <tr>
            <td>SMTP Server</td>
            <td><label>
              <input type="text" name="smtp_server" id="smtp_server" />
              <i>(e.g: smtp@mysite)</i></label></td>
          </tr>
