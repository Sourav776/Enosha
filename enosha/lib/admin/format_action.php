...
if (isset($_POST['pass_event']) == 'ext_add')
{
 ...
 */
elseif (isset($_POST['pass_event']) == 'type_add')
{
echo $_POST['type_add'];
	$_SESSION['user_display_format']="block";
	if($_POST['type']!=NULL){
 ...
 */
elseif (isset($_POST['pass_event']) == 'type_remove')
{
	$_SESSION['user_display_format']="block";
 ...
 */
elseif (isset($_POST['pass_event']) == 'set_type')
{
	$_SESSION['user_display_format']="block";
