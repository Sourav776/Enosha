  ...
  <div id="con">
    <div id="inner">
      <div class="left floatl3"><!-- InstanceBeginEditable name="EditRegion8" -->
        <!-- ////////////////////////////////////////////////////////////////////////////////////////////////////// -->
        <p><a href="../../../index.php"><?php echo $home ?></a> <img src="../../../images/insert.png" alt="link" width="12" height="11" /> <?php echo $edit_user ?></font></p>
        <p align="right">
          <?php logged_in_user(); ?>
        </p>
        <br />
        ...
        <div id="helpdiv" style="display:block">
          <p align="center"> <?php echo "<font color="."#000000"."><b>"; echo $_SESSION[msg]; echo "</font></b>"?></p>
        </div>
              ...
              <tr>
                ...
                <table width="408" border="0" cellpadding="5" cellspacing="5">
                    ...
                    <tr>
                      ...
                      <td><label>
                      <?php
					  if ($user_id == $_SESSION['id']) echo "<input type=\"text\" name=\"display_name\" id=\"display_name\" value=\"".$d_name."\"/>"; else echo $d_name; ?>
                    ...
                    <tr>
                      ...
                      <td><label>
                       <?php
					    if ($user_id == $_SESSION['id']) echo "<input type=\"text\" name=\"email\" id=\"email\" value=\"".$e_mail."\"/>"; else echo $e_mail; ?>
                        </label></td>
                    </tr>
                    <tr>
                      ...
                      <td><label>
                         <?php
					    if ($user_id == $_SESSION['id']) echo  "<input type=\"text\" name=\"country\" id=\"country\" value=\"".$country."\"/>"; else echo $country; ?>
                        </label></td>
                    </tr>	
                    <?php $additional = "			    
                    <tr>
					...
					if ($user_id == $_SESSION['id']) echo $additional;
					?>
                  </table>
            </form>
