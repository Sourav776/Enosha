...
$user_type_added = isset($_SESSION['user_com_mes']);
$user_type_exists = isset($_SESSION['user_exist_mes_ex']);
if(isset($_SESSION['user_type_display']) == ""){
...
if(isset($_SESSION['user_rights_assign'])==""){
...
<!-- InstanceBegin template="/Templates/LOR.dwt" codeOutsideHTMLIsLocked="false" -->
<head>
  ...
  <div id="con">
    <div id="inner">
      <div class="left floatl3"><!-- InstanceBeginEditable name="EditRegion8" -->
        <!-- ////////////////////////////////////////////////////////////////////////////////////////////////////// -->
        <p><a href="../../../index.php"><?php echo $home ?></a> <img src="../../../images/insert.png" alt="link" width="12" height="11" /> <?php echo $user_administration ?></font></p>
        <p align="right">
          <?php logged_in_user() ?>
        </p>
        ...
        <div class="ContentArea">
          ...
          <table>
            <form id="form6" name="form6" method="post" action="user_action.php" onsubmit="return validateForm();">
              ...
              <tr>
                <td valign="top"><table width="350" border="0">
                    <tr id="change1">
                      <td width="107"><?php echo $user_name ?></td>
                      <td colspan="2"><label>
                    ...
                    <tr id="change4">
                      ...
                      <td colspan="2"><label>
                        ...
                        <div id='password_confirm_div' class="notice"></div>
                        </label></td>
                    </tr>
                    <tr id="change5">
	  		...
	  		?>
                    ...
                    <tr id="change6">
                      ...
                      <td colspan="2"><label>
                        ...
                        <div id='email_div' class="notice"></div></td>
                    </tr>
                    <tr>
                      <td><b><?php echo $optional_data_notice ?></b></td>
                    </tr>
                    <tr id="change7">
                    ...
                    <tr>
                      ...
                      <td width="155" align="right"><a href=# class="button" onClick="document.form6.formVar.value='add_user'; validateForm(); "><span><img src="../../../images/add.png" width="12"/> Add </span></a></td>
                    </tr>
                  </table>
            </form>
            </td>
            ...
            <tr>
              <td><?php user_check(); ?></td>
              <!-- method located in admin/user_search -->
            </tr>
          </table>
          </td>
          <td></td>
        ...
        <div id="Layer3">
          <table class="ContentArea">
            <tr  class="BlueHeader"onclick="toggleUserSearch();">
              ...
              <td align="right"><a id="displayUserSearch" style="font-size:12px; color:#FFFFFF;" onmouseover="this.style.cursor='pointer';"><?php echo $show ?></a></td>
            </tr>
          </table>
          <div id="userSearch" style="display: <?php echo $userSearch_display; ?>">
            <table class="ContentArea">
              ...
              <tr>
                <td><br />
                  <?php user_search($page);?></td>
                <!-- method located in admin/users/user_search -->
              </tr>
            </table>
            </td>
            </tr>
        ...
        <table class="ContentArea">
          <tr  class="BlueHeader"onclick="toggleUserTypes();">
            ...
            <td align="right"><a id="displayUserType" style="font-size:12px; color:#FFFFFF;" onmouseover="this.style.cursor='pointer';"><?php echo $show ?></a></td>
          </tr>
        </table>
        ...
        <form id="form3" name="form3" method="post" action="user_action.php">
          <table width="650" border="0" class=ContentArea cellpadding="10" cellspacing="10">
            <tr>
              <?php if(isset($_SESSION['user_com_mes'])) echo "<b>".$user_type_added."</b>"; elseif(isset($_SESSION['user_exist_mes_ex'])) echo  "<b>".$user_type_exists."</b>";  ?>
            </tr>
            <tr>
